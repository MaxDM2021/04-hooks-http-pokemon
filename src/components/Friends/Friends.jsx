...
export default function Friends() {
    ...
    // useMemo для мемонизации, сохраняет состояниие функции до тех пор пока не произойдет изменение
...
const visibleFriends = friends.filter(friends => friends.toLowerCase().includes(filter)); 
